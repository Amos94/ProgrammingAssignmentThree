#ALL CREDITS TO: NSchrading
#CODE FROM: https://github.com/NSchrading/intro-spacy-nlp
#https://nicschrading.com/
...
def getDeps(toks):
    ...
    for tok in toks:
        dict[str(tok)] = [tok.orth_, tok.dep_, tok.pos_, tok.head.orth_, [t.orth_ for t in tok.lefts], [t.orth_ for t in tok.rights]]
